...
#    print("len(graph_ref_list): ", len(graph_ref_list))
#    print("len(graph_pred_list): ", len(graph_pred_list))
...
#        print("aaa")
    ...
    print("len(total_counts_ref): ", len(total_counts_ref))
    print("len(total_counts_pred): ", len(total_counts_pred))
    mmd_dist = mmd.compute_mmd(total_counts_ref, total_counts_pred, kernel=mmd.gaussian,
